    ...
    recipes: [
        {
            ...
            ingredients: [
                { name: "Butter", amount: 4, scale: "oz", type: "Dairy" },
                { name: "Fettuccine", amount: 16, scale: "oz", type: "Grain" },
                { name: "Parmesan", amount: 2, scale: "cups", type: "Dairy" },
                { name: "Heavy Cream", amount: 24, scale: "oz", type: "Dairy" }
            ]
        },
        {
            ...
            ingredients: [
                ...
                { name: "Peanut Butter", amount: 2, scale: "tsp", type: "Misc" },
                { name: "Strawberry Jam", amount: 2, scale: "tsp", type: "Misc" }
            ]
        },
        {
            ...
            ingredients: [
                ...
                { name: "Peanut Butter", amount: 1, scale: "tsp", type: "Misc" }
            ]
        }
    ]
};
